...
const Footer = () => {
  return (
    <footer className="flex flex-col text-black bg-white bottom-0 w-full items-center bg-blend-multiply md:pb-14 md:pt-36 md:px-24 md:h-[35.75rem] font-poppins outline-none">
